...
<div id="label-page"><h3>Tampil Data Staf</h3></div>
<div id="content">
	
	<p id="tombol-tambah-container"><a href="index.php?p=staf-input" class="tombol"><button type="button" class="btn btn-dark">Tambah staf</button></a>
